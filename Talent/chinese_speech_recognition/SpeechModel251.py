...
from chinese_speech_recognition.general_function.file_dict import *
from chinese_speech_recognition.general_function.gen_func import *
...
from chinese_speech_recognition.readdata24 import DataSpeech
...
class ModelSpeech(): # 语音模型类
	...
	def RecognizeSpeech(self, wavsignal, fs):
		...
		list_symbol_dic = GetSymbolList('chinese_speech_recognition/' + self.datapath) # 获取拼音列表
