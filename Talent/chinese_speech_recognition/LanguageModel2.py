...
class ModelLanguage(): # 语音模型类
	...
	def LoadModel(self):
		self.dict_pinyin = self.GetSymbolDict('chinese_speech_recognition/dict.txt')
		self.model1 = self.GetLanguageModel('chinese_speech_recognition/' + self.modelpath + 'language_model1.txt')
		self.model2 = self.GetLanguageModel('chinese_speech_recognition/' + self.modelpath + 'language_model2.txt')
		self.pinyin = self.GetPinyin('chinese_speech_recognition/' + self.modelpath + 'dic_pinyin.txt')
